...
export default function InterviewerSetup() {
  ...
  const createInterview = (e: FormEvent) => {
    e.preventDefault()
    // Record history
    addHistory({
      type: 'interview',
      ...
      <form onSubmit={createInterview} className="grid md:grid-cols-2 gap-8">
        ...
        <div>
          ...
          <div className="mt-6">
            ...
            <textarea
              className="w-full min-h-[140px] rounded-xl border-2 border-gray-200 p-3 focus:border-primary-500 focus:ring-0"
        ...
        <div>
          ...
          <div className="grid grid-cols-1 gap-4">
            <div>
              ...
              <input className="w-full rounded-xl border-2 border-gray-200 p-3 focus:border-primary-500"
                value={interviewConfig.jobTitle}
                onChange={(e) => setInterviewConfig({ ...interviewConfig, jobTitle: e.target.value })} required />
            </div>
            <div>
              <label className="block text-sm font-medium mb-1">Language</label>
              <select className="w-full rounded-xl border-2 border-gray-200 p-3 focus:border-primary-500"
            ...
            <div>
              ...
              <textarea className="w-full min-h-[120px] rounded-xl border-2 border-gray-200 p-3 focus:border-primary-500"
          ...
          <button type="submit" className="mt-6 w-full py-3 rounded-xl bg-gradient-to-r from-primary-600 to-primary-700 text-white font-semibold shadow hover:shadow-lg">
            Create Interview
          </button>
        </div>
      </form>
