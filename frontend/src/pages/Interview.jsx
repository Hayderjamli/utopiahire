      ...
      <div className="grid md:grid-cols-2 gap-6 mt-6">
        ...
        <div className="bg-white rounded-2xl p-4 border border-gray-200">
          ...
          <div className="mt-3">
            {useTyping ? (
              <textarea 
                className="w-full min-h-[160px] rounded-xl border-2 border-gray-200 p-3 focus:border-indigo-500"
          ...
          <button onClick={startInterview} className="mt-4 w-full py-3 rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-semibold shadow hover:shadow-lg">
            Start Interview
          </button>
        </div>
      </div>
